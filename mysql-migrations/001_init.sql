...
CREATE TABLE `users` (
  ...
  `password_hash` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `full_name` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `role` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'student',
...
CREATE TABLE `email_otps` (
  ...
  `purpose` VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'signup_verify',
  `expires_at` DATETIME(6) NOT NULL,
...
CREATE TABLE `user_identities` (
  ...
  `provider_account_id` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `sms_log` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `to_number` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `status` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'queued',
  `provider_message_id` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `admin_audit_log` (
  ...
  `actor_email` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `action` VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `target_type` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `target_id` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `summary` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `app_error_log` (
  ...
  `context` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `detail` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `fingerprint` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `occurrences` INT NOT NULL DEFAULT 1,
  `first_seen_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `last_seen_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `resolved_at` DATETIME(6) NULL,
  `resolved_by` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
  `error_name` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `error_code` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `digest` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `environment` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `release` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  ...
  `metadata` JSON NOT NULL DEFAULT (_utf8mb4'{}'),
  `fingerprint_open` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (IF(`resolved_at` IS NULL, `fingerprint`, NULL)) VIRTUAL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `exams` (
  ...
  `exam_session` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `exam_questions` (
  ...
  `instruction` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `layout_pattern` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `order_index` SMALLINT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `exam_question_parts` (
  ...
  `ai_grading_hint` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `exam_question_options` (
  ...
  `option_key` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `order_index` SMALLINT NOT NULL,
...
CREATE TABLE `questions` (
  ...
  `poem` JSON NULL,
  `audio_url` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `difficulty` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'medium',
  `created_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
CREATE TABLE `vocab_words` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `grade` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `image` VARCHAR(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
CREATE TABLE `vocab_answers` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `user_id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `grade` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `lesson` SMALLINT NOT NULL,
  `word` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `meaning` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `image` VARCHAR(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
CREATE TABLE `jasoos_levels` (
  ...
  `content_type` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `verse_line_1` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `verse_line_2` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
) AUTO_INCREMENT=1000 ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `jasoos_suspects` (
  ...
  `evidence` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `word_in_verse` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `sort_index` SMALLINT NOT NULL DEFAULT 0,
...
CREATE TABLE `jasoos_answers` (
  ...
  `verse_line_1` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `verse_line_2` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `chosen_role` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `correct_role` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `is_correct` TINYINT(1) NOT NULL,
  `answered_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_bookmarks` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `user_id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `area` VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `ref_id` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `title` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `club_posts` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `user_id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `author_name` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `is_anonymous` TINYINT(1) NOT NULL DEFAULT 0,
  `title` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `body` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `form` VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'other',
  `tags` JSON NOT NULL,
  `meter` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `club_reports` (
  ...
  `target_type` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `note` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `status` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'open',
  `resolved_at` DATETIME(6) NULL,
  `resolved_by` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
  `created_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
CREATE TABLE `aruz_bridge_questions` (
  ...
  `phrase` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `correct_pattern` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `wrong_pattern` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `grammar_circuit_questions` (
  ...
  `grade` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `lesson` SMALLINT NOT NULL,
  `question_type` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'sentence',
  `payload` JSON NOT NULL,
  `difficulty` SMALLINT NOT NULL DEFAULT 2,
  `explanation` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `attribution` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `memory_pairs` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `grade` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `term` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `work` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `ninja_categories` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `label` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `hint` VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
CREATE TABLE `ninja_words` (
  ...
  `word` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `sort_index` SMALLINT NOT NULL DEFAULT 0,
  `created_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
...
CREATE TABLE `site_announcements` (
  ...
  `title` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `body` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `tone` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'info',
  `link_url` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `link_label` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `site_supporters` (
  `id` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL,
  `display_name` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `message` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `tier` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'supporter',
  `amount_label` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `link_url` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `avatar_url` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
...
CREATE TABLE `content_reports` (
  ...
  `status` VARCHAR(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'open',
  `admin_note` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `resolved_at` DATETIME(6) NULL,
  `resolved_by` CHAR(36) CHARACTER SET ascii COLLATE ascii_general_ci NULL,
  `created_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
