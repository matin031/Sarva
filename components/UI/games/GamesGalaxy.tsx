...
const STOPS: Stop[] = [
  ...
  },
  {
    ...
    tag: "تقطیعِ عروضی",
    title: "کوتاه یا بلند؟",
    desc: "متنِ اعراب‌گذاری‌شده را چند ثانیه می‌بینی، بعد پوشانده می‌شود و باید واحدها را یکی‌یکی تقطیع کنی. یک اشتباه، و از اول.",
    steps: [
      "متنِ کاملِ اعراب‌گذاری‌شده را ببین و در ذهنت تقطیعش کن",
      "متن پوشانده می‌شود و واحدها یکی‌یکی می‌آیند",
      "هر پاسخِ درست کمی از متن را باز می‌کند؛ یک اشتباه، و از واحدِ اول",
    ],
