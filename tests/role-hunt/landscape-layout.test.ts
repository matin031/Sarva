 ...
 *
 * ⚠️ عمداً سخاوتمند است. اندازه‌گیریِ واقعی روی ۸۴۴×۳۹۰: نوارِ فشرده ۳۴،
 * HUD یک‌ردیفه ۲۶، رمزگشا ۴۲، فاصله‌ها ۱۶. اگر روزی یکی از این‌ها بزرگ‌تر
 * شود، عددِ اینجا باید بالا برود — و آن‌وقت همین تست می‌گوید کدام گوشی
 * دیگر جا نمی‌شود.
 */
const CHROME = 118;
