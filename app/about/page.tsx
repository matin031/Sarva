  ...
  return (
        ...
        <div className=" relative">
          ...
          font-semibold py-1 bg-primary/10 text-primary"
           ...
           mb-2 text-balance"
            ...
            >
              عروضینو زادۀ یک باور است: دانشِ کهنِ عروض نباید در قفسۀ کتاب‌ها
        ...
        >
          ...
          <div className="text-center font-semibold">
            ...
            <p className="text-muted-foreground leading-relaxed text-center">
              عروضینو تلاشی است برای پُل‌زدن میانِ این میراثِ کهن و نسلِ امروز.
          ...
          >
            ...
            >
              ...
              <p className="text-primary font-medium mb-4">
                دبیر ادبیات فارسی و سازندۀ پلتفرم عروضینو
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                می‌تپد. عروضینو را آنجا ساختم که این دو عشق به هم رسیدند: ادبیات
    ...
    py-1.5 rounded-lg"
                ...
                >
                  ...
                  توسعه‌دهندۀ وب و سازندۀ عروضینو
                </motion.span>
              </motion.div>
            </motion.div>
          </motion.div>
        ...
        rounded-full right-20 top-0 z-100 absolute"
          ...
          >
            ...
            >
              ...
              پیام، گامی است برای بهترشدنِ عروضینو
            </motion.p>
            <motion.div
              variants={containerVariants}
