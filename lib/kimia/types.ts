...
export type KimiaRound = {
  ...
  /**
   * منبعِ بیت: `quiz` = بانکِ عروضِ سماعی، `kimia` = بیت‌های مخصوصِ همین
   * بازی (`kimia_verses`). فقط برای اینکه «گزارشِ اشکال» به جای درست برسد؛
   * هیچ چیزی از پاسخ از آن استنتاج نمی‌شود.
   */
  readonly source: "quiz" | "kimia";
