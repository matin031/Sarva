...
export const metadata: Metadata = {
  ...
  description:
    "ده بازی برای یادگیریِ ادبیات و دستور زبان فارسی: جاسوسِ نقش‌ها، نینجای دستور زبان، جفت‌های ادبی، واژه‌یاب، تقطیعِ سریع، پلِ وزن، مدار دستور، شکار نقش‌ها، کیمیای وزن و رنگ‌آرا.",
};
