...
export const SETTING_SPECS: Record<SettingKey, SettingSpec> = {
  ...
  "sms.driver": {
    ...
    label: "سرویس پیامک",
    description:
      "تا وقتی روی «غیرفعال» باشد هیچ پیامکی فرستاده نمی‌شود و فقط در گزارش ثبت می‌شود. فقط «نجوا» پیاده‌سازی شده؛ بقیه فعلاً به حالت غیرفعال برمی‌گردند.",
    options: [
      { value: "mock", label: "غیرفعال (فقط ثبت در گزارش)" },
      { value: "najva", label: "نجوا" },
