export type NinjaRound = {
  id: number;
  /** شناسهٔ نقش در پایگاه‌داده.
   *
   *  ⚠️ `id` بالا فقط جای این راند در همین فهرست است و بینِ دو بار خواندن
   *  عوض می‌شود؛ برای گزارشِ محتوا بی‌فایده است. نقش‌های ثابتِ داخلِ کد این
   *  را ندارند، چون ردیفی در پایگاه‌داده ندارند که به آن لینک شود. */
  categoryId?: string;
  category: string;
  hint: string;
  targetWords: string[];
