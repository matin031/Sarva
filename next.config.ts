...
const nextConfig: NextConfig = {
  ...
  outputFileTracingExcludes: {
    "/uploads/**": [
      ...
      //
      // بدون این خط، deploy/ (که یک zip چهل‌مگابایتی دارد) در خروجی
      // standalone می‌نشست و بستهٔ بعدی آن را با خودش می‌برد — یعنی هر
      // build حجم را چند ده مگابایت زیاد می‌کرد، به‌صورت تصاعدی.
      "./deploy/**/*",
      "./cpanel-app.js",
      "*.md",
      "*.yml",
