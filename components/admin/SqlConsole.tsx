 ...
 *
 * ⚠️ و یک محدودیت که از مهاجرت به MySQL آمد: این کنسول فقط SELECT و DML
 * می‌پذیرد. دستورهای تغییرِ اسکیما (CREATE / ALTER / DROP / TRUNCATE) در
 * MySQL «commit ضمنی» دارند — تراکنش را پیش از خودشان می‌بندند — پس
 * پیش‌نمایششان واقعاً اجرا می‌شد و بعد گزارش می‌داد «چیزی ذخیره نشد».
 * به‌جای یک وعدهٔ دروغین، جلویشان گرفته شده و جایشان در migration هاست.
 */
    ...
    <div dir="rtl" className="flex max-w-6xl flex-col gap-6 p-4 xs:p-6">
      <header className="flex flex-col gap-2">
        ...
        <p className="max-w-3xl text-sm text-muted-foreground">
          ...
          در پایان برمی‌گردد و هیچ چیزی ذخیره نمی‌ماند. تغییر ساختار جدول‌ها (create / alter /
          drop / truncate) اینجا ممکن نیست و جایش در فایل‌های migration است.
        </p>
      </header>
