...
--      چون هر نوشتنی از سرور می‌آید. اعتبارسنجی‌شان به lib/club/actions.ts می‌رود.
--
...
-- lib/club/queries.ts زندگی می‌کند. تفاوت مهم: آنجا یک فیلترِ فراموش‌شده هم بی‌خطر
