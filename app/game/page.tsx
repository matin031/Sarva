...
export const metadata: Metadata = {
  ...
  description:
    "نُه بازی برای یادگیریِ ادبیات و دستور زبان فارسی: جاسوسِ نقش‌ها، نینجای دستور زبان، جفت‌های ادبی، واژه‌یاب، تقطیعِ سریع، پلِ وزن، مدار دستور، شکار نقش‌ها و کیمیای وزن.",
};
