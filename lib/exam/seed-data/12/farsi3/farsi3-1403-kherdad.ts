import { highlight1, highlightThenBlank, poemLines, text, ul } from "../../helpers";
    ...
    // ----------------------------------------------------------------- زبانی
    {
      ...
      questions: [
        ...
        },
        {
          ...
          pageRef: 163,
          instruction:
            `با توجّه به بیت زیر، به پرسش‌ها پاسخ دهید. «به سوزی ده کلامم را روایی/ کز آن گرمی کند ${ul("آتش")} گدایی»`,
          layoutPattern: "multi-subquestion",
          parts: [
            {
              label: "الف",
