...
const STEPS = [
  {
    n: "۱",
    title: "بیت تصادفی را بزن",
    body: "یک بیت از گنجور می‌آید و خودش دو مصراع را پر می‌کند. هر بار یک شاعر و یک وزن تازه.",
  },
  {
    n: "۲",
    title: "حالت استادی را روشن کن",
    body: "قبل از دیدن جواب، ارکان را حدس بزن؛ مثلاً «مفاعیلن مفاعیلن فعولن».",
  },
  {
    n: "۳",
    ...
    >
      <div className=" glass overflow-hidden rounded-3xl p-5 sm:p-8">
        ...
        <p className=" mt-4 leading-relaxed text-muted-foreground">
          وزن‌یاب فقط برای وقتی نیست که وزن را نمی‌دانی. یک بیت ناآشنا بگیر،
